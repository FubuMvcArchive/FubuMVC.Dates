...
RESULTS_DIR = "results"
PRODUCT = "FubuMVC.Dates"
COPYRIGHT = 'Copyright 2012 FubuMVC.Dates. All rights reserved.';
...
task :compile => [:restore_if_missing, :clean, :version] do
  MSBuildRunner.compile :compilemode => COMPILE_TARGET, :solutionfile => 'src/FubuMVC.Dates.sln', :clrversion => CLR_TOOLS_VERSION
